...
class _ApiService implements ApiService {
  ...
  @override
  Future<LoginResponseBody> loginUser(LoginRequestBody requestBody) async {
  ...
  @override
  Future<SignupResponseBody> registerUser(SignupRequestBody requestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ProductsResponseBody> getProducts() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ProductsResponseBody>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProductsResponseBody _value;
    try {
      _value = ProductsResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<ProductsResponseBody> searchProducts(String query) async {
    final _extra = <String, dynamic>{};
  ...
  Future<ProductDetailModel> addProduct(
    AddProductRequestBody requestBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
